...
import { DateInput } from "@/features/dashboard/components/DateInput";
import { editEventSchema } from "@/features/create-event/schemas";
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="col-span-2 space-y-2">
                <div className="relative h-32 w-32 border-2 border-red-400">
                  <Image
                    src={selectedImage || "/default-thumbnail.png"}
                    alt="thumbnail"
                    fill
                  ...
                  <Input
                    ...
                    value={
                      formik.values.endDate
                        ? format(new Date(formik.values.endDate), "HH:mm")
                        : ""
                    }
                    onChange={(e) => {
                      const [hours, minutes] = e.target.value.split(":");
